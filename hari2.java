...
//Tipe data primitif memiliki nilai yang dapat langsung digunakan, 
...
public class day2 {
    public static void main(String[] args) {
        ...
        char golonganDarah = 'B'; // Ini adalah tipe data primitif untuk karakter
        boolean  menikah = true; // Ini adalah tipe data primitif untuk nilai boolean false dan true
        double beratBadan = 56.9; // ini adalah tipe data double untuk bilangan pecahan
        ...
        Character golongan = new Character('B'); // Ini adalah objek golongan untuk tipe data char
        Boolean status = new Boolean(false); // Ini adalah objek status untuk tipe data boolean
        Double bb = new Double(56.9); // ini adalah objek bb atau berat badan untuk tipe data double 
